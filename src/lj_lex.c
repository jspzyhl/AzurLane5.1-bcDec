...
int lj_lex_setup_mod(int L, _DWORD *ls)
{
	signed int v2; // eax
	signed int v3; // edx
	...
	*ls = 0;
	...
	ls[17] = 1;
	ls[18] = 1;
	v2 = (int)lex_next((LexState*)ls);
	ls[8] = v2;
	if (v2 == 88)
	{
		v10 = (_BYTE *)ls[6];
		result = 0;
		if (*v10 == 65 && v10[1] == 78 && v10[2] == 65)
			LABEL_14:
		result = 1;
	}
	else
	{
		...
		if (v2 != 239)
		{
			while (1)
			{
				if (v2 == 35)
				{
					do
					{
						v6 = (unsigned __int8 *)ls[6];
						if ((unsigned int)v6 < ls[7])
						{
							ls[6] = (_DWORD)(v6 + 1);
							v5 = *v6;
							ls[8] = v5;
						...
						{
							v5 = (int)lex_next((LexState*)ls);
							ls[8] = v5;
							if (v5 == -1)
								return 0;
						}
					} while (v5 != 13 && v5 != 10);
					lex_newline((LexState*)ls);
					if (ls[8] != 27)
						return 0;
				}
				else
				...
				v11 = lj_err_str_mod(L, 2972);
				v12 = *(int **)(L + 20);
				*(_DWORD *)(L + 20) = (_DWORD)(v12 + 2);
				*v12 = v11;
				v12[1] = -5;
		...
		if ((unsigned int)(v7 + 2) <= v8 && *v7 == -69 && v7[1] == -65)
		{
			ls[6] = v9;
			if (v9 >= v8)
				goto LABEL_27;
			ls[6] = (uint32_t)(v7 + 3);
			v2 = (unsigned __int8)v7[2];
			goto LABEL_20;
		}
	}
	return result;
